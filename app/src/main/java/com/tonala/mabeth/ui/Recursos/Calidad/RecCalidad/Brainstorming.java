...
public class Brainstorming extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animationView = (LottieAnimationView) findViewById(R.id.animPrinci40);
        animationView.setAnimation(R.raw.brainstorm);

        animationView = (LottieAnimationView) findViewById(R.id.animPrinci41);
        animationView.setAnimation(R.raw.solucion);
